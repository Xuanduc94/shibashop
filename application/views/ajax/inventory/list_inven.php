    ...
    <div class="col-md-12 padd-0">
        ...
        <div class="col-md-4 padd-right-0">
            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title blue" style="font-size: 25px;"><?php echo (isset($total_sls) ? $total_sls : '0'); ?></h3>
        ...
        <div class="col-md-4 padd-right-0">
            <div class="report-box " style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title orange" style="font-size: 25px;"><?php echo (isset($totaloinvent) ? cms_encode_currency_format($totaloinvent) : '0'); ?></h3>
                    <span class="infobox-data-number text-center" style="font-size: 14px; color: #555;">Tổng vốn tồn kho</span>
                </div>
            </div>
        </div>
        <div class="col-md-6 padd-right-0" style="margin-top: 10px;">
            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                <div class="infobox-icon">
                    <i class="fa fa-shopping-cart cred" style="font-size: 45px;"></i>
                </div>
                <div class="infobox-data">
                    <h3 class="infobox-title cred" style="font-size: 25px;"><?php echo (isset($totalsinventretail) ? cms_encode_currency_format($totalsinventretail) : '0'); ?></h3>
                    <span class="infobox-data-number text-center" style="font-size: 14px; color: #555;">Tổng giá trị tồn lẻ</span>
                </div>
            </div>
        </div>
        <div class="col-md-6 padd-right-0 " style="margin-top: 10px;">
            ...
            <div class="infobox-data">
                <h3 class="infobox-title cred" style="font-size: 25px;"><?php echo (isset($totalsinventwhole) ? cms_encode_currency_format($totalsinventwhole) : '0'); ?></h3>
                <span class="infobox-data-number text-center" style="font-size: 14px; color: #555;">Tổng giá trị tồn sỉ</span>
            </div>
        </div>
    </div>
</div>
...
<table class="table table-bordered table-striped">
    <thead>
        <tr>
            ...
            <th class="text-center">Giá tồn lẻ</th>
            <th class="text-center">Giá tồn sỉ</th>
        </tr>
    </thead>
    <tbody>
        <?php if (isset($data['_list_product']) && count($data['_list_product'])) :
            foreach ($data['_list_product'] as $key => $item) : ?>
                <tr>
                    <td onclick="cms_view_product(<?php echo $item['ID']; ?>)" style="color: #2a6496; cursor: pointer;"><?php echo $item['prd_code']; ?></td>
                    ...
                    <td class="text-right"><?php echo cms_encode_currency_format($item['prd_retail_price'] * $item['quantity']); ?></td>
                    <td class="text-right"><?php echo cms_encode_currency_format($item['prd_whole_price'] * $item['quantity']); ?></td>
                </tr>
        <?php endforeach;
        else :
