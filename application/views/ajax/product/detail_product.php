                ...
                <div class="col-md-6">
                    <div class="right-action text-right">
                        <div class="btn-groups">
                            <button type="button" class="btn btn-primary" style="background-color: #8B8B8B;" onclick="cms_deactivate_product_bydetail(<?php echo $_detail_product['ID']; ?>)"><i class="fa fa-pause"></i> Ngừng kinh doanh
                            </button>
                            <button type="button" class="btn btn-primary " onclick="cms_edit_product(<?php echo $_detail_product['ID']; ?>)"><i class="fa fa-pencil-square-o"></i> Sửa thông tin
                            </button>
                            <button type="button" class="btn btn-danger" onclick="cms_delete_product_bydetail(<?php echo $_detail_product['ID']; ?>)"><i class="fa fa-trash-o"></i> Xóa
                            </button>
