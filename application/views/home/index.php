        ...
        <div class="col-md-3">
            <div class="report-box box-green">
                ...
                <div class="infobox-data">
                    ...
                    <span class="infobox-data-number text-center"><?php echo (isset($tongtien)) ? cms_encode_currency_format($tongtien) : '0'; ?></span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="report-box box-blue">
                ...
                <div class="infobox-data">
                    ...
                    <span class="infobox-data-number text-center"><?php echo (isset($slsorders)) ? cms_encode_currency_format($slsorders) : '0'; ?></span>

                    <h3 class="infobox-title">Số sản phẩm:</h3>
                    <span class="infobox-data-number text-center"><?php echo (isset($slsitem)) ? cms_encode_currency_format($slsitem) : '0'; ?></span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="widget widget-blue">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($tongtien)) ? cms_encode_currency_format($tongtien) : '0'; ?></b></div>
                    <div class="info col-xs-7">Số đơn hàng</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($slsorders)) ? cms_encode_currency_format($slsorders) : '0'; ?></b></div>
                    <div class="info col-xs-7">Số sản phẩm</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($slsitem)) ? cms_encode_currency_format($slsitem) : '0'; ?></b></div>
        ...
        <div class="widget widget-orange">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($slsinventory)) ? cms_encode_currency_format($slsinventory) : '0'; ?></b></div>
                    <div class="info col-xs-7">Hết Hàng</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($slsaceitem)) ? cms_encode_currency_format($slsaceitem) : '0'; ?></b></div>
        ...
        <div class="widget widget-green">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($data['_sl_product'])) ? $data['_sl_product'] : 0; ?></b>
                        / <b><?php echo (isset($data['_sl_manufacture'])) ? $data['_sl_manufacture'] : 0; ?></b></div>
                    <div class="info col-xs-7">Chưa làm giá bán</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($lamgiaban)) ? cms_encode_currency_format($lamgiaban) : '0'; ?></b></div>
                    <div class="info col-xs-7">Chưa nhập giá mua</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($lamgiamua)) ? cms_encode_currency_format($lamgiamua) : '0'; ?></b></div>
...
<div class="row" style="margin: 20px 0; overflow: hidden; ">
    <div class="chart-report">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-globe"></i>Tin tức</div>
                    <div class="panel-body">
