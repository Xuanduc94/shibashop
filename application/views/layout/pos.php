...
<head>
    ...
    <script type="text/javascript">
        window.$zopim || (function(d, s) {
            ...
            $.src = "https://v2.zopim.com/?2Z9j3qQJSSSIytel3Hsn5sCSk4aspfwy";
            z.t = +new Date;
            $.
                                                    ...
                                                    <div class="tab-contents" style="padding: 8px 6px;">
                                                        <div class="form-group marg-bot-10 clearfix">
                                                            <div style="padding:0px" class="col-md-6">
                                                                <label><input checked type="radio" name="type_sell" value="0" /> Bán lẻ</label>
                                                            </div>
                                                            <div style="padding:0px" class="col-md-6">
                                                                <label><input type="radio" name="type_sell" value="1" /> Bán sỉ</label>
                                                        ...
                                                        <div class="form-group marg-bot-10 clearfix">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="col-md-10 padd-0" style="position: relative;">
                                                                    <input id="search-box-cys" class="form-control" type="text" placeholder="Tìm khách hàng (F4)" style="border-radius: 3px 0 0 3px !important;"><span style="color: red; position: absolute; right: 5px; top:5px; " class="del-cys"></span>
